			...
			<div class="content-area">
              ...
              <table style="width:100%">
                <tr>
                  ...
                  <td class="secTd"><input type="text" id="partnerName" name="" value=""></td>
                </tr>
                <tr>
                  <td>合作商地址：</td>
                ...
                <tr>
                  <td>邮编：</td>
                  <td colspan="3" class="secTd">
                    <input type="text" id="zipCode" name="" value="">
                  </td>
                </tr>
                <tr>
                  <td>联系人：</td>
                  <td class="secTd">
                      <input type="text" name="" id="contacts" value="">
                  </td>
                  <td style="text-align:right;">手机号码：</td>
                  <td class="secTd">
                      <input type="text" name="" id="contactPhone" value="">
                  </td>
                </tr>
                <tr>
                  <td>门店电话：</td>
                  <td colspan="3" class="secTd">
                      <input type="text" name="" id="storePhone" value="">
                  </td>
                </tr>
                <tr>
                  <td>销售员：</td>
                  <td colspan="3" class="secTd">
                      <input type="text" name="" id="salesman" value="">
                  </td>
                </tr>
              </table>
            </div>
            ...
            <div class="ib-content clearfix">
              <table style="width:100%">
				...
				<div class="btnCase clearfix">
					...
					<button class="bc-confirm" id="addBtn" type="button" onclick="return add();">保 存</button>
				</div>
			</div>
		</div>
	</div>
