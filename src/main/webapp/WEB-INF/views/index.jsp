...
<body class="no-skin">
				...
				<ul>
					<li>
						<!--
							...
							--> <img class="" alt=""
						src="/jiacerconsole/static/loginImg/logo.png"> <%-- <a href="#" class="navbar-brand">
				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="${ctxStatic}/loginImg/account.png" alt="用户头像" /> <span
							class="user-info"> 欢迎,${fns:getUser().loginName} </span> <i
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<!-- 主内容 page-->
				<iframe id="mainFrame" name="mainFrame" src="" frameborder="no"
					width="100%" height="100%" onLoad="iFrameHeight()"> </iframe>
				<%--<webview src="html/applys/1/form.html"  style="display:inline-flex; width:100%; height:100%" nodeintegration></webview>--%>
			</div>
		</div>
		<!-- 页脚-->
		<div class="footer">
			<div class="footer-inner">
				<div class="footer-content">
					<span class="bigger-120"> <a href="javascript:void(0)">${fns:getConfig('productName')}</a>
						&copy; 2015-${fns:getConfig('copyrightYear')} - Powered By
	...
	<div class="modal fade bs-example-modal-sm in" id="myModal"
				...
				<div class="modal-body">
					<form id="inputForm" method="post"
						...
						<div class="form-group">
							<label class="col-md-3 control-label">旧密码:<span
								class="dr-asterisk">*</span></label>
							<div class="col-md-5">
								<input id="oldPassword" maxlength="10" value=""
						...
						<div class="form-group">
							<div class="col-sm-8 panel-toolbar text-center dr-slash-text">
								<input id="btnSubmit" class="btn btn-primary" type="button"
									value="保 存" onclick="user.modifyPwd();" />
							</div>
						</div>
					</form>
				</div>
	...
	<script type="text/javascript">
			...
			$(function(){
				...
				if(referer.indexOf("formAudit")!=-1){
				$("body").find("#menu li:eq(0) a").trigger("click")
				$("body").find(".submenu li:eq(0) a span").trigger("click")
				}
			});
