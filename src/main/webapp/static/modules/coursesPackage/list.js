	...
	query:function(){
		$(grid_selector).jqGrid({
			...
			colModel:[
				...
				{name:'packageName',index:'packageName', width:160,sortable:false},
				{name:'applyCourses',index:'applyCourses', width:80,sortable:false,formatter:countFormatter},
				{name:'originalPrice',index:'originalPrice', width:130,sortable:false},
